...
public class SynthInstrument extends BaseInstrument {
  ...
  public void updateEvents() {
    MWEngineCoreJNI.SynthInstrument_updateEvents(swigCPtr, this);
  }

  public boolean removeEvent(BaseAudioEvent audioEvent, boolean isLiveEvent) {
    return MWEngineCoreJNI.SynthInstrument_removeEvent(swigCPtr, this, BaseAudioEvent.getCPtr(audioEvent), audioEvent, isLiveEvent);
  }
