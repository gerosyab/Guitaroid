...
public class SequencerController {
  ...
  public void prepare(int aBufferSize, int aSampleRate, float aQueuedTempo, int aTimeSigBeatAmount, int aTimeSigBeatUnit) {
    MWEngineCoreJNI.SequencerController_prepare(swigCPtr, this, aBufferSize, aSampleRate, aQueuedTempo, aTimeSigBeatAmount, aTimeSigBeatUnit);
  }
  ...
  public void setBounceState(boolean aIsBouncing, int aMaxBuffers, String aOutputDirectory) {
    MWEngineCoreJNI.SequencerController_setBounceState(swigCPtr, this, aIsBouncing, aMaxBuffers, aOutputDirectory);
  }

  public void setRecordingState(boolean aRecording, int aMaxBuffers, String aOutputDirectory) {
    MWEngineCoreJNI.SequencerController_setRecordingState(swigCPtr, this, aRecording, aMaxBuffers, aOutputDirectory);
  }

  public void setRecordingFromDeviceState(boolean aRecording, int aMaxBuffers, String aOutputDirectory) {
    MWEngineCoreJNI.SequencerController_setRecordingFromDeviceState(swigCPtr, this, aRecording, aMaxBuffers, aOutputDirectory);
  }
